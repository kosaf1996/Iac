...
sed -i 's/localhost/mydb.cvjbzsr9mg5j.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
cat > /var/www/html/health << EOF
<html><body><h1> GMGU WEB SERVER</h1></body></html>
EOF
